...
#define __ARM64 arm64
#define __INTEL x86

// golang register-based ABI via https://tip.golang.org/src/cmd/compile/abi-internal
#if ARCH == __ARM64
#define GO_PARAM1(x) BPF_CORE_READ((x), r0)
#define GO_PARAM2(x) BPF_CORE_READ((x), r1)
#define GO_PARAM3(x) BPF_CORE_READ((x), r2)
#define GO_PARAM4(x) BPF_CORE_READ((x), r3)
#define GO_PARAM5(x) BPF_CORE_READ((x), r4)
#define GO_PARAM6(x) BPF_CORE_READ((x), r5)
#define GO_PARAM7(x) BPF_CORE_READ((x), r6)
#define GO_PARAM8(x) BPF_CORE_READ((x), r7)
#define GO_PARAM9(x) BPF_CORE_READ((x), r8)
#define GOROUTINE(x) BPF_CORE_READ((x), r22)
#define GO_SP(x) BPF_CORE_READ((x), rsp)
#elif ARCH == __INTEL
