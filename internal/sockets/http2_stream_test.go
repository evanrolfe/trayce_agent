...
// var _ = Describe("Http2Stream", func() {
// 	Context("Processing a settings payload", Ordered, func() {
// 		flows := []*sockets.Flow{}
...
// 		BeforeAll(func() {
// 			stream := sockets.NewHttp2Stream()

// 			for _, payload := range payloads {
// 				flow := stream.ProcessDataEvent(&bpf_events.DataEvent{
// 					Pid:      123,
// 					Tid:      123,
// 					Fd:       5,
// 					DataType: 1,
